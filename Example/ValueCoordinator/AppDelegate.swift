...
//protocol ObjectMapper<SourceType, ResultType> {
...
//}
//
//class IntMapper: ObjectMapper {
//   func map(_ object: ArticleDict) -> Int {
//      // Mapping...
//      return 10
//   }
//}
...
//    var mapper: AnyObjectMapper<ArticleDict, Article>! = AnyObjectMapper(ArticleMapper())
//    var mapper2: (any ObjectMapper<ArticleDict, Article>) = IntMapper()
//}
...
//        let t = T()
//        _ = t.observe(\.t, changeHandler: { t, v in
//
//        })
        return true
    }
